...
export function normalizeProductAnalysis(value: Partial<ProductAIAnalysis>): ProductAIAnalysis {
  return {
    ...
    includes: asString(value.includes),
    ...
    players: asString(value.players),
    online_support: asString(value.online_support),
    warranty_notes: asString(value.warranty_notes),
...

{
  ...
  "includes": "o que parece acompanhar o produto",
  ...
  "players": "ex: 1 jogador, 1-4 local, conforme o jogo",
  "online_support": "ex: Offline, Online opcional, Requer assinatura, Não se aplica",
  "warranty_notes": "observação curta de garantia/teste",
