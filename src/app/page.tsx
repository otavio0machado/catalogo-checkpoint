    ...
    <div className="LandingShell min-h-screen bg-[#111] text-white">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#111]/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-5">
          <Logo />
          <Link href="/loja" className="MotionButton rounded-full bg-brand-400 px-4 py-2 text-sm font-black text-[#111] transition hover:bg-brand-300">
        ...
        <section className="mx-auto grid max-w-5xl gap-8 px-5 pb-10 pt-10 sm:grid-cols-[1.1fr_.9fr] sm:items-center sm:pb-20 sm:pt-20">
          <div>
            ...
            <div className="LandingReveal mt-7 flex flex-col gap-3 sm:flex-row [animation-delay:180ms]">
              <Link href="/loja" className="MotionButton inline-flex items-center justify-center rounded-xl bg-brand-400 px-6 py-3.5 text-sm font-black uppercase text-[#111] transition hover:bg-brand-300 active:scale-[0.98]">
                <span>Ver catálogo</span>
              ...
              <Link href="/carrinho" className="MotionButton inline-flex items-center justify-center rounded-xl border border-white/15 px-6 py-3.5 text-sm font-bold text-white transition hover:border-brand-300 hover:text-brand-200">
                <span>Carrinho</span>
              </Link>
            </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-5 px-5 py-8 sm:grid-cols-3">
            {[
              ...
              <div key={title} className="StepCard flex gap-4 rounded-xl p-2 transition">
                <span className="StepNumber grid h-9 w-9 shrink-0 place-items-center rounded-full bg-brand-400 text-sm font-black text-[#111]">{index + 1}</span>
                <div>
